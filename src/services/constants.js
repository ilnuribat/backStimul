...
const OBJECT_DELETED = 'OBJECTS_DELETED';
const AREA_CREATED = 'AREA_CREATED';
const AREA_UPDATED = 'AREA_UPDATED';
const AREA_DELETED = 'AREA_DELETED';
...
const STATUSES = {
  ...
  KAZNA: [
    { id: 21, name: 'Новое' },
    { id: 22, name: 'Открыт счет' },
    { id: 23, name: 'Выставлен счет на аванс' },
  ],
};
